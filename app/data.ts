...
export const hamburgers: Products = [
	{
		id: 1,
		title: 'Sicilian',
		desc: 'Ignite your taste buds with a fiery combination of spicy pepperoni, jalapeños, crushed red pepper flakes, and melted mozzarella cheese, delivering a kick with every bite.',
		img: '/temporary/h1.png',
		price: 24.9,
		options: [
			{
				title: 'Small',
	...
	},
	{
		...
		desc: 'Experience pure cheesy bliss with a melty blend of mozzarella, cheddar, provolone, and Parmesan cheeses, creating a rich and indulgent burger experience.',
		img: '/temporary/h6.png',
		price: 22.9,
		options: [
			{
				title: 'Small',
